...
class MemoryInternalCommunicationConverterTest {
    ...
    fun `convert _ all MemoryData instances _ should do nothing`() {
        ...
        MemoryInternalCommunicationConverter()
            ...
            ) shouldBe transformedDataDescriptor
    }

    @Test
    fun `convert _ should convert Data to MemoryData and delete old data resource`() {
    ...
    @Test
    fun `convert _ should delete data descriptor resources`() {
        val data = mockk<Data> {
            every { delete() } just Runs
        }
