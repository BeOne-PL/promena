...
import pl.beone.lib.promena.connector.http.extension.isInstanceOfInnerPrivateStaticClass
import pl.beone.lib.promena.connector.http.extension.retryOnError
...
class HttpClientAlfrescoPromenaTransformer(
...
) : AlfrescoPromenaTransformer, AbstractPromenaHttpTransformer(serializationService, httpClient) {
    ...
    private fun determineTransformationDescriptor(transformation: Transformation, nodeDescriptors: List<NodeDescriptor>): TransformationDescriptor =
        transformationDescriptor(transformation, alfrescoDataDescriptorGetter.get(nodeDescriptors), externalCommunicationParameters)
