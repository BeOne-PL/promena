package pl.beone.promena.alfresco.module.rendition.predefined.internal
...
internal val supportedLibreOfficeConverterMediaTypes = listOf<(MediaType) -> Boolean>(
...
internal val supportedImageMagickConverterMediaTypes = listOf<(MediaType) -> Boolean>(
    { it == APPLICATION_PDF },
    { it == IMAGE_PNG },
    { it == IMAGE_JPEG },
    { it == IMAGE_GIF },
