...
class InMemoryOrFileAlfrescoDataConverterTestIT : AbstractUtilsAlfrescoIT() {
    ...
    fun createData_withoutLocationInMemoryData() {
        ...
        InMemoryOrFileAlfrescoDataConverter(Memory).createData(node.getContentReader()).let {
    ...
    fun createData_withLocationFileData() {
        ...
        try {
            ...
            InMemoryOrFileAlfrescoDataConverter(File, tmpDir.toURI())
    ...
    fun saveDataInContentWriter_inMemoryData() {
        ...
        InMemoryOrFileAlfrescoDataConverter(Memory, null)
