...
class TransformerResponseErrorAttemptsExceededFlowTest {
    ...
    companion object {
        ...
        private val transformationParameters = TransformationParameters(emptyList(), "123456789", customRetry(0, Duration.ZERO), attempt, "admin")
    ...
    fun `shouldn't receive any message because the number of attempts has been exceeded`() {
        ...
        jmsUtils.sendResponseErrorMessage(id, exception, transformationParameters)
