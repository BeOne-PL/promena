...
/**
 * Adopted from com.cedarsoftware:java-util:1.38.0
 * It allows to pass an empty capacity
 *
...
public class FastByteArrayOutputStream extends OutputStream
{
    ...
    /**
     * Construct a new FastByteArrayOutputStream with a logical size of 0 and empty capacity of 'capacity'.
     * @param capacity int capacity (internal buffer size), must be &ge; 0
    ...
    public FastByteArrayOutputStream(int capacity, int delta)
    {
        if (capacity < 0)
        {
            throw new IllegalArgumentException("Capacity must be at least 0 byte, passed in capacity=" + capacity);
        }
